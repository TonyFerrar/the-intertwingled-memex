---
title: "Calc-1 Discussion 08 - Revisit max and min"
type: problem
course: MATH-181
semester: Fall 2026
publish: true
...
# Calc-1 Discussion 08 - Revisit max and min

**Discussion Topics covered:** *Revisit max and min / How to create a function from words*
...
### Problem 1
Apply concepts of **Revisit max and min** to solve a model problem.
...
### Problem 2
Solve an engineering calculus problem involving: **Revisit max and min**.
...
### Problem 3
Analyze: **How to create a function from words**.
