---
title: "Session 15 - Optimizing Distance and Time"
type: course-session
course: MATH-181
semester: Fall 2026
publish: true
...
# Session 15 - Optimizing Distance and Time
...
> [!example] Engineering Context: The Fastest Path and the Shortest Time
> In this session, we investigate the mathematical principles of **Optimizing Distance and Time** and explore how engineers apply these concepts to analyze real-world physical and structural systems.
...
- Core takeaways from Session 15 and overview of homework Knewton: *Optimization Problems in Other Contexts*.
