---
title: "Calc-1 Discussion 04 - Limit definition of a"
type: problem
course: MATH-181
semester: Fall 2026
publish: true
...
# Calc-1 Discussion 04 - Limit definition of a

**Discussion Topics covered:** *Limit definition of a derivative / Limit definition of a derivative with an annoying function to see the usage of the rules*
...
### Problem 1
Apply concepts of **Limit definition of a derivative** to solve a model problem.
...
### Problem 2
Solve an engineering calculus problem involving: **Limit definition of a derivative**.
...
### Problem 3
Analyze: **Limit definition of a derivative with an annoying function to see the usage of the rules**.
