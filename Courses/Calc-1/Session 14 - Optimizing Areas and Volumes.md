---
title: "Session 14 - Optimizing Areas and Volumes"
type: course-session
course: MATH-181
semester: Fall 2026
publish: true
...
# Session 14 - Optimizing Areas and Volumes
...
> [!example] Engineering Context: Designing Efficient Structures
> In this session, we investigate the mathematical principles of **Optimizing Areas and Volumes** and explore how engineers apply these concepts to analyze real-world physical and structural systems.
...
- Core takeaways from Session 14 and overview of homework Knewton: *Optimization Problems in a Geometric Context*.
