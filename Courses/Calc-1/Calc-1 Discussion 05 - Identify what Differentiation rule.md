---
title: "Calc-1 Discussion 05 - Identify what Differentiation rule"
type: problem
course: MATH-181
semester: Fall 2026
publish: true
...
# Calc-1 Discussion 05 - Identify what Differentiation rule

**Discussion Topics covered:** *Identify what Differentiation rule would be needed and which one works better / Derivatives without ignoring dx/dx*
...
### Problem 1
Apply concepts of **Identify what Differentiation rule would be needed and which one works better** to solve a model problem.
...
### Problem 2
Solve an engineering calculus problem involving: **Identify what Differentiation rule would be needed and which one works better**.
