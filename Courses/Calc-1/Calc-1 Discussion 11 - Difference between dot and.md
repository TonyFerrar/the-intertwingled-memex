---
title: "Calc-1 Discussion 11 - Difference between dot and"
type: problem
course: MATH-181
semester: Fall 2026
publish: true
...
# Calc-1 Discussion 11 - Difference between dot and

**Discussion Topics covered:** *Difference between dot and cross product and revisit i cross i and etc / Review from topics*
...
### Problem 1
Apply concepts of **Difference between dot and cross product and revisit i cross i and etc** to solve a model problem.
...
### Problem 2
Solve an engineering calculus problem involving: **Difference between dot and cross product and revisit i cross i and etc**.
