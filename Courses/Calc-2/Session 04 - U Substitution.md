...
- **Step 3: Substitute everything back into the integral.**
    ...
    $$\int \underbrace{(u - 2)}_{x} \cdot \underbrace{u^{1/2}}_{\sqrt{x+2}} \, \underbrace{du}_{dx}$$
...
* [[Electrical Engineering — Non-linear Power Dissipation]]
[[Electrical Engineering — Non-linear Power Dissipation Solution]]

* [[Aerospace Engineering — Thermal Damping Wave Propagation]]
...
- **Step 2: Substitute components into the integral.**
    ...
    $$\int \underbrace{\cos(x^3 + 4)}_{\cos(u)} \cdot \underbrace{3x^2 \, dx}_{du} = \int \cos(u) \, du$$
...
#### Real-Life Engineering Application Problems
* [[Civil Engineering — Hydrostatic Force on a Curved Dam Wall]]
[[Civil Engineering — Hydrostatic Force on a Curved Dam Wall Solution]]

* [[Mechanical Engineering — Mechanical Shear Stress in a Shaft]]
...
$$\left( \frac{1}{2}(1)^2 \right) - \left( \frac{1}{2}(0)^2 \right) = \frac{1}{2} - 0 = \frac{1}{2}$$

**Final Answer:**
$$\frac{1}{2}$$
_(Fun side note: You can solve this by picking $u = \sec(x)$ instead. If you try it that way, your new limits will be $1$ to $\sqrt{2}$, but the math beautifully shakes out to give you the exact same answer!)_
...
#### Real-Life Engineering Application Problems
* [[Electrical Engineering — Capacitor Energy Charging]]
[[Electrical Engineering — Capacitor Energy Charging Solution]]

* [[Nuclear Engineering — Thermal Energy Generation Startup Phase]]
...
Apply the Fundamental Theorem of Calculus:
$$2 \big( \sin(\pi) - \sin(0) \big) = 2 (0 - 0) = 0$$

**Final Answer:**
$$0$$
_(Fun fact: The answer is exactly zero because the positive area under the curve cancels out the negative area under the curve!)_
