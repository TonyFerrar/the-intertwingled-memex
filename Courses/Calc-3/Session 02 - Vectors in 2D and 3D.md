---
title: "Session 02 - Vectors in 2D and 3D"
type: course-session
course: MATH-283
semester: Fall 2026
publish: true
...
# Session 02 - Vectors in 2D and 3D
...
> [!example] Engineering Context: Navigating the 3D World
> In this session, we investigate the mathematical principles of **Vectors in 2D and 3D** and explore how engineers apply these concepts to analyze real-world physical and structural systems.
...
- Core takeaways from Session 02 and overview of homework homework assignment: *Vectors in the Plane
