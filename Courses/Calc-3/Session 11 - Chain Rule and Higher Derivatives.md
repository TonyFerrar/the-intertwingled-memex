---
title: "Session 11 - Chain Rule and Higher Derivatives"
type: course-session
course: MATH-283
semester: Fall 2026
publish: true
...
# Session 11 - Chain Rule and Higher Derivatives
...
> [!example] Engineering Context: Sensitivity and Change
> In this session, we investigate the mathematical principles of **Chain Rule and Higher Derivatives** and explore how engineers apply these concepts to analyze real-world physical and structural systems.
...
- Core takeaways from Session 11 and overview of homework homework assignment: *Second Partial Derivative and Chain Rule*.
