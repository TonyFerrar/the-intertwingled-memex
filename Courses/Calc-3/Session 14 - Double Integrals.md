---
title: "Session 14 - Double Integrals"
type: course-session
course: MATH-283
semester: Fall 2026
publish: true
...
> [!example] Engineering Context: Finding What’s Underneath
> In this session, we investigate the mathematical principles of **Double Integrals** and explore how engineers apply these concepts to analyze real-world physical and structural systems.
...
- Core takeaways from Session 14 and overview of homework homework assignment: *Double Integrals over Rectangular Regions Part 1
