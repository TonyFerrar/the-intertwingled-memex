# Calculus I — Learning Activity #0
...
---
3. Use the function given to evaluate the following: 
...
---
4. Let $f(x) = \sqrt{x^2 - 1}$ and $g(x) = x + 1$. 
...
---
5. Find the equation of the line through the point $(1, 7)$ with slope $\frac{2}{3}$. Present your answer in slope-intercept form. 
...
---
6. Find the solutions to the following: 
* (a) $1 - (4 - (5 - x)) = 3x - (4 + x)$ 
...
---
7. Given $\sin(\theta) = \frac{12}{13}$ and $\frac{\pi}{2} < \theta < \pi$, find the other 5 trigonometric values. 
[[Trigonometry Review]]
...
---
8. Find the inverse, $f^{-1}(x)$, of the following functions: 
...
10. Using the properties of logarithms, express the given quantity as a single logarithm: $$\ln(a+b) + \ln(a-b) - 2\ln c$$
[[Logarithmic Review]]
...
---
11. Evaluate the following. Keep in mind the restricted function values for inverse trig functions: 
...
12. Determine if the following functions are even, odd, or neither: 
* (a) $f(x) = 5x^4 - 3x^2 + 7$ 
...
<p align="center">Modeling Practices in Calculus Project<br>Shared under Creative Commons BY-NC-SA 4.0 license</p>
